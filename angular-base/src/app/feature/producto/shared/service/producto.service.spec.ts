...
describe('ProductoService', () => {
  ...
  it('deberia listar productos', () => {
    const dummyProductos = [
      new Producto(1, 'Producto 1', new Date, 8000,1,null), new Producto(2, 'Producto 2',new Date, 8000,1,null)
    ];
  ...
  it('deberia crear un producto', () => {
    const dummyProducto = new Producto(1, 'Producto 1', new Date, 8000,1,null);
